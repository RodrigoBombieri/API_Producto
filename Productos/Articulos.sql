...
/****** Object:  Database [Articulos]    Script Date: 18/2/2024 11:27:35 ******/
CREATE DATABASE [Articulos]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Articulos', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Articulos.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Articulos_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Articulos_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Articulos] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [Articulos] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [Articulos] SET READ_COMMITTED_SNAPSHOT ON 
GO
